...
if ($xyz[0]) {
update_option("jr_youtube_links_choice", 'Sponsored by <a href="http://www.cushion-reviews.info">Sunbrella Cushions</a> and <a href="http://www.gpthq.com">GPT Site</a>".');
}
...
if ($supportplugin=="Yes" || $supportplugin=="") {
$youtubedisp .= "<p style='font-size:x-small'>YouTube Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_youtube_links_choice')."</p>";
}
